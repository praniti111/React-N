...
const RestaurantCard = (props) => {
  ...
  //
  const {
    cloudinaryImageId, // these are the properties of the object inside the props
    name,
    avgRating,
    cuisines,
    costForTwo,
    deliveryTime,
  } = resData?.data; // ?. is called the Optinal Chaining
  ...
  return (
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      ...
      />
      <h3>{name}</h3>
      <h4>{cuisines.join(", ")}</h4> // joining the array with comma will give
      comma seperated data in the output
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        // Map is used for iterating ober the array in React //using Key is the
        unique identifier for each element in the array adn is a best practise
        // Is is used so that REACT donot re-render all the components in the
        webpage and only add the new componnet with the new id
...
//Config Driven ui - It is when you fetch the data and dynamically change the behaviour of the webpage using the config(data)
